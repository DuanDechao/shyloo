...
PyObject* FixedDict::__py_reduce_ex__(PyObject* self, PyObject* protocol)
{
	...
	PyObject* unpickleMethod = sl::pyscript::Pickler::getUnpickleFunc("FixedDict");
...
PyObject* FixedDict::__unpickle__(PyObject* self, PyObject* args)
{
	...
	FixedDict* pFixedDict = new FixedDict((PyDataType*)DataTypeMgr::getDataType(uid));
...
PyObject* FixedDict::update(PyObject* args)
{
	...
	for(; iter != keyTypes.end(); ++iter)
	{
		...
		{
			//PyObject* val1 = 
			//	static_cast<FixedDictType*>(getPyDataType())->createNewItemFromObj(iter->first.c_str(), val);
