...
public:																										\
	...
	{																										\
		...
		if(!PyDict_Check(dictData)){																		\
			printf(#CLASS"::createNamespace: create"#CLASS"[%s:%d] "										\
				"args is not a dict.\n",																	\
				scriptName(), id_);																			\
			return;																							\
		}																									\
		...
		Py_XDECREF(cellDataDict);																			\
																											...
																											\
	void addCellDataToStream(uint32 flags, sl::MemoryStream* mstream, bool useAliasID = false);				\
																											\
	PyObject* createCellDataFromStream(sl::MemoryStream* mstream)											\
	{																										\
		...
		{																									\
			...
			{																								\
				printf(#CLASS"::createCellDataFromStream: not found uid(%d)\n", uid);						\
				break;																						\
			}																								\
																											\
		...
		return cellData;																					\
																											...
																											\
	void addCellDataToStreamByDetailLevel(int8 detailLevel, sl::MemoryStream* mstream, bool useAliasID = false)	\
	{																										\
		...
		SCRIPT_ERROR_CHECK();																				\
																											...
																											\
	void addClientDataToStream(sl::MemoryStream* s, bool otherClient = false)									\
	{																										\
		...
		Py_XDECREF(pydict);																					\
																											...
																											\
	void addPositionAndDirectionToStream(sl::MemoryStream& s, bool useAliasID = false);							\
																											\
	...
	{																										\
		...
		return flags_;																						\
																											...
																											\
	inline int32 spaceID() const																			\
	{																										\
		return spaceID_;																					\
	}																										\
	inline void spaceID(int32 id)																		\
	{																										\
		spaceID_ = id;																						\
	}																										\
...
#define ENTITY_CPP_IMPL(APP, CLASS)																			\
	...
	{																										\
		...
		{																									\
			...
			{																								\
				printf(fmt::format("{}::initProperty: not found old_module!\n",							\
		...
		{																									\
			...
			{																								\
				printf(#CLASS"::initProperty: %s dataType is NULL.\n",										\
