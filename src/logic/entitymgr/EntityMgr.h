...
class EntityMgr : public IEntityMgr, public IMonitorListener, public sl::api::ITimer, public sl::SLHolder<EntityMgr>{
public:
	virtual bool initialize(sl::api::IKernel * pKernel);
	virtual bool launched(sl::api::IKernel * pKernel);
	virtual bool destory(sl::api::IKernel * pKernel);
	
	virtual void onRemoteMethodCall(const uint64 objectId, const sl::OBStream& stream);
