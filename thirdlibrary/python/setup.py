...
class PyBuildExt(build_ext):
    ...
    def detect_modules(self):
        ...
        search_for_ssl_incs_in = [
                              os.getenv("SL_ROOT") + '/shyloo/thirdlibrary/openssl/include/',
                              os.getenv("SL_ROOT") + 'shyloo/thirdlibrary/openssl/include/',
                              os.getcwd()[0 : os.getcwd().find("shyloo/thirdlibrary") + len("shyloo/thirdlibrary")] + '/openssl/include/',
                             ]
        ...
        ssl_libs = find_library_file(self.compiler, 'ssl',[],
                                     [os.getenv("SL_ROOT") + '/shyloo/src/sllib/libs',
                                     os.getenv("SL_ROOT") + 'shyloo/src/sllib/libs',
                                     os.getcwd()[0 : os.getcwd().find("shyloo/src/sllib/") + len("shyloo/src/sllib/")] + 'libs/',
                                     ] )
