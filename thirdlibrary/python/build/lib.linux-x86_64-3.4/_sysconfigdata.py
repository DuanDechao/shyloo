...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -DDEBUG -g -fwrapv -o0 -Wall '
           '-Wstrict-prototypes',
 ...
 'COVERAGE_INFO': '/root/mf/shyloo/thirdlibrary/python/coverage.info',
 'COVERAGE_REPORT': '/root/mf/shyloo/thirdlibrary/python/lcov-report',
 ...
 'LDFLAGS': '',
 'LDLAST': '',
 'LDLIBRARY': '/root/mf/shyloo/src/sllib/libs/libpython.a',
 'LDLIBRARYDIR': '',
 ...
 'LIBRARY': '/root/mf/shyloo/src/sllib/libs/libpython.a',
 'LIBRARY_OBJS': '\\',
 ...
 'LIPO_32BIT_FLAGS': '',
 'LN': 'ln',
 'LOCALMODLIBS': '-L/root/mf/shyloo/src/sllib/libs -lssl -lcrypto',
 ...
 'MKDIR_P': '/bin/mkdir -p',
 'MODLIBS': '-L/root/mf/shyloo/src/sllib/libs -lssl -lcrypto',
 'MODOBJS': 'Modules/_threadmodule.o  Modules/signalmodule.o  '
            ...
            'Modules/symtablemodule.o  Modules/_ssl.o  Modules/md5module.o  '
            'Modules/sha1module.o  Modules/sha256module.o  '
            'Modules/sha512module.o  Modules/xxsubtype.o',
 'MODULE_OBJS': '\\',
 ...
 'OPCODETARGETS_H': '\\',
 'OPT': '-DDEBUG -g -fwrapv -o0 -Wall -Wstrict-prototypes',
 'OTHER_LIBTOOL_OPT': '',
 'PACKAGE_BUGREPORT': 0,
 'PACKAGE_NAME': 0,
 'PACKAGE_STRING': 0,
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-Wno-unused-result -DDEBUG -g -fwrapv -o0 -Wall '
              '-Wstrict-prototypes',
 'PY_CFLAGS_NODIST': '-Werror=declaration-after-statement',
 'PY_CORE_CFLAGS': '-Wno-unused-result -DDEBUG -g -fwrapv -o0 -Wall '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/root/mf/shyloo/thirdlibrary/python:/usr/local/lib',
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SLLIBDIR': '/root/mf/shyloo/src/sllib/libs',
 'SL_PYTHONLIB': '/root/mf/shyloo/src/sllib/libs/libpython.a',
 'SOABI': 'cpython-34m',
 'SRCDIRS': 'Parser Grammar Objects Python Modules Mac',
 'SRC_GDB_HOOKS': './Tools/gdb/libpython.py',
 'SSL': '/root/mf/shyloo/thirdlibrary/openssl',
 'STDC_HEADERS': 1,
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/root/mf/shyloo/thirdlibrary/python:/usr/local/lib '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/root/mf/shyloo/thirdlibrary/python:/usr/local/lib '
 ...
 'abs_builddir': '/root/mf/shyloo/thirdlibrary/python',
 'abs_srcdir': '/root/mf/shyloo/thirdlibrary/python',
